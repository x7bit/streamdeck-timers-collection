...
function connected(jsn) {
    ...
    $SD.on('com.rayco.workdaytimer.action.willAppear', (jsonObj) => action.onWillAppear(jsonObj));
    $SD.on('com.rayco.workdaytimer.action.keyUp', (jsonObj) => action.onKeyUp(jsonObj));
    $SD.on('com.rayco.workdaytimer.action.sendToPlugin', (jsonObj) => action.onSendToPlugin(jsonObj));
    $SD.on('com.rayco.workdaytimer.action.didReceiveSettings', (jsonObj) => action.onDidReceiveSettings(jsonObj));
    $SD.on('com.rayco.workdaytimer.action.propertyInspectorDidAppear', (jsonObj) => {
        console.log('%c%s', 'color: white; background: black; font-size: 13px;', '[app.js]propertyInspectorDidAppear:');
    });
    $SD.on('com.rayco.workdaytimer.action.propertyInspectorDidDisappear', (jsonObj) => {
